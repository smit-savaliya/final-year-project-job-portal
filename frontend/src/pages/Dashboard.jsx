...
const Dashboard = () => {
  ...
  const {companyData , setCompanyData , setCompanyToken} = useContext(AppContex)
    ...
    <div className='min-h-screen'>
        ...
        <div className='px-5 flex justify-between items-center'>
          ...
          {companyData &&  (
            ...
            <div className='relative group'>
              <img className='w-10  border  border-black  rounded-full' src={companyData.image} alt="" />
      ...
      <div className='flex items-start'>
        <div className='inline-block  min-h-screen border-r-2'>
          <ul className='flex flex-col items-start pt-5 text-green-800'>
